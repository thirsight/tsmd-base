...
class DeviceDetectHelper
{
    ...
    public static function init($userAgent = null) {
        self::$detect = new MobileDetect(null, $userAgent);
    ...
    private static function getIp() {
        ...
        else { self::$ipAddress = $_SERVER['REMOTE_ADDR'] ?? '127.0.0.2'; }
    ...
    public static function isMobile() {
        return self::$detect->isMobile(self::$userAgent);
    }

    public static function isTablet() {
        return self::$detect->isTablet(self::$userAgent);
    }

    public static function isPhone() {
        return (self::$detect->isMobile(self::$userAgent) ? (self::$detect->isTablet(self::$userAgent) ? false : true) : false);
    }

    public static function isComputer() {
        return (self::$detect->isMobile(self::$userAgent) ? false : true);
    }

    public static function deviceType() {
        return (self::$detect->isMobile(self::$userAgent) ? (self::$detect->isTablet(self::$userAgent) ? 'Tablet' : 'Phone') : 'Desktop');
    }
    ...
    public static function isEdge() {
        $agent = self::$userAgent ?: (isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : '');
